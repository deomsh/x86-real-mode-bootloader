...
;0x0000000000000013:  40 0B                inc        ax
	MEDIA			dw 	0xF8			; MEDIA	  DB	  0F8H			; MEDIA BYTE
...
;0x0000000000000024:  00 00             add        byte [bx + si], al
...
; keystroke.
	jb         	CKErr				; Points to Non-System Message
CKERR:
	MOV			SI,OFFSET SYSMSG	; point to no system message ; now at 0xf0
